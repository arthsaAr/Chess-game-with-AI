...
public class pieceRuleEngine extends Piece {
    public pieceRuleEngine(String color, Coordinate position) {
    ...
    @Override
    public Piece copy() {
        return new pieceRuleEngine(this.color, new Coordinate(this.position.getRow(), this.position.getCol()));
    }
